...
public class QProjectMember extends EntityPathBase<ProjectMember> {
    ...
    private static final long serialVersionUID = 357030629L;
    ...
    public final EnumPath<com.project.devtogether.participant.domain.enums.ParticipantStatus> status = createEnum("status", com.project.devtogether.participant.domain.enums.ParticipantStatus.class);
